                            ...
                            <tbody>
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <button class='btn btn-danger'><a class='text-light' style='text-decoration: none;' href='delete.php?user_id=" . $row['user_id'] . '&' . $row['blood_type'] . "'>Delete</a></button>
                                        </div>
                                        </td>
                                        </tr>";
                                    }
                                    ...
                                    if ($fromSearch) {
                                        ...
                                        echo "<tr>
                                            <td colspan='9'>
                                                <div class='alert alert-warning' role='alert'>We're sorry, but there are no donors yet!
                                                </div>
                                            </td>
                                        </tr>";
                                    }
