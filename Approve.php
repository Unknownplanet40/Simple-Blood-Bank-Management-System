...
if (isset($_GET['user_id'])) {
    ...
    // ge aet the available blood stock
    ...
    if (empty($blood) || empty($amount)) {
        $_SESSION['message'] = "We could not find the blood type or the amount of blood requested";
        $_SESSION['icon'] = "info";
    ...
    $_SESSION['message'] = "We can't Verify your request, please try again";
    $_SESSION['icon'] = "info";
    $_SESSION['isTrue'] = true;
    header("Location: " . $_SERVER['HTTP_REFERER']);
}
